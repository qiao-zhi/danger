			...
			<div class="panel-body el_main">
				...
				<div class="el_qlmContent">
					...
					<div class="row el_queryBox">
						...
						<!--提交查询按钮-->
						<button type="submit"
							class="btn btn-default el_queryButton btn-sm" id="condition_sub">查询</button>
					</div>
					<!--结束 查询表单提交-->
								...
								<form>
									<div class="modal-body">
										<div class="input-group el_modellist" role="toolbar">
											<span class="el_spans">上级机构编号：</span> <input type="text"
										...
										<div class="input-group el_modellist" role="toolbar">
											<span class="el_spans">机构名称：</span> <input type="text"
												class="form-control el_modelinput" id="unit__name" name="" />
											<span></span>
										</div>
										<div class="input-group el_modellist" role="toolbar">
											<span class="el_spans">机构负责人：</span> <input type="text"
												class="form-control" id="unit__manager" />
										</div>
										<div class="input-group el_modellist" role="toolbar">
											<span class="el_spans">联系方式：</span> <input type="text"
												class="form-control" id="unit__phone" />
										</div>
									</div>
							...
							<div class="modal-content">
								...
								<form>
									<div class="modal-body">
										...
										<div class="input-group el_modellist" role="toolbar">
											<span class="el_spans">机构名称：</span> <input type="text"
												class="form-control el_modelinput" id="unit___name" name="" />
											<span></span>
										</div>
										<div class="input-group el_modellist" role="toolbar">
											<span class="el_spans">机构负责人：</span> <input type="text"
												class="form-control" id="unit___manager" name="" />
										</div>
										<div class="input-group el_modellist" role="toolbar">
											<span class="el_spans">联系方式：</span> <input type="text"
												class="form-control" id="unit___phone" name="" />
										</div>
									</div>
									<div class="modal-footer">
										<button type="button" class="btn btn-primary"
