                        ...
                        <div class="panel panel-default">
                            <div class="panel-body el_MainxiaoMain">
                                <div class="el_topButton">
                                    ...
                                    <button type="button" class="btn btn-primary" id="dictionary_delete">删除</button>
                                ...
                                <div class="modal-body">
                                    <div class="input-group el_modellist" role="toolbar">
                                        ...
                                        <input type="text" class="form-control" 
                                        	id="dap_add_id" name="" disabled/>
                                    </div>
									<div class="input-group el_modellist" role="toolbar">
                                        <span class="el_spans">上级字典名称：</span>
                                        <input type="text" class="form-control" 
                                        	id="dap_add_name" name="" disabled/>
                                    </div>
                                    <div class="input-group el_modellist" role="toolbar">
                                        <span class="el_spans">字典名称：</span>
                                        <input type="text" class="form-control" id="dictionary_name" name=""/>
                                    </div>
                                    <div class="input-group el_modellist" role="toolbar">
                                        <span class="el_spans">字典编号：</span>
                                        <input type="text" class="form-control" id="dictionary_id" name="" readonly="readonly"/>
                                    </div>
                                    <div class="input-group el_modellist" role="toolbar">
                                    ...
                                    <div class="input-group el_modellist" role="toolbar">
                                        ...
                                        <textarea class="form-control el_modelinput" id="dictionary_description" rows="2"></textarea>
                                    </div>
                                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form>
                                <div class="modal-body">
                                	<div class="input-group el_modellist" role="toolbar">
                                        <span class="el_spans">上级字典编号：</span>
                                        <input type="text" class="form-control" id="upDicId" name="" disabled/>
                                    </div>
									<div class="input-group el_modellist" role="toolbar">
                                        <span class="el_spans">上级字典名称：</span>
                                    ...
                                    <div class="input-group el_modellist" role="toolbar">
                                        <span class="el_spans">字典编号：</span>
                                        <input type="text" class="form-control" id="dict_id" name="" disabled/>
                                    </div>
                                    <div class="input-group el_modellist" role="toolbar">
                                        <span class="el_spans">字典名称：</span>
                                        <input type="text" class="form-control" id="dict_name" name=""/>
                                    </div>
                                    <div class="input-group el_modellist" role="toolbar">
                                        <span class="el_spans">字典状态：</span>
                                    ...
                                    <div class="input-group el_modellist" role="toolbar">
                                        <span class="el_spans">字典描述：</span>
                                        <textarea class="form-control el_modelinput" id="dict_description" rows="2"></textarea>
                                    </div>
                                </div>
                                <div class="modal-footer">
