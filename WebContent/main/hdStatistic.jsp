									...
									<div class="row el_queryBoxrow">
										...
										<div class="col-md-3 el_qlmQuery">
											<div class="input-group" role="toolbar">
												<span class="el_spans">时间：</span> <input type="text"
											...
											<c:forEach var="tongjiInfo" items="${result.tongjiInfoList}"
												...
												<tr>
													...
													<td><a href="javascript:void(0)"
														onclick="queryNum('${tongjiInfo.checkunit }','A','')">${tongjiInfo.aji }</a></td>
													<td><a href="javascript:void(0)"
														onclick="queryNum('${tongjiInfo.checkunit }','B','')">${tongjiInfo.bji }</a></td>
													<td><a href="javascript:void(0)"
														onclick="queryNum('${tongjiInfo.checkunit }','C','')">${tongjiInfo.cji }</a></td>
													<td><a href="javascript:void(0)"
														onclick="queryNum('${tongjiInfo.checkunit }','','采煤')">${tongjiInfo.caimei }</a></td>
													<td><a href="javascript:void(0)"
														onclick="queryNum('${tongjiInfo.checkunit }','','开掘')">${tongjiInfo.kaijue }</a></td>
													<td><a href="javascript:void(0)"
														onclick="queryNum('${tongjiInfo.checkunit }','','机电')">${tongjiInfo.jidian }</a></td>
													<td><a href="javascript:void(0)"
														onclick="queryNum('${tongjiInfo.checkunit }','','运输')">${tongjiInfo.yunshu }</a></td>
													<td><a href="javascript:void(0)"
														onclick="queryNum('${tongjiInfo.checkunit }','','通风')">${tongjiInfo.tongfeng }</a></td>
													<td><a href="javascript:void(0)"
														onclick="queryNum('${tongjiInfo.checkunit }','','地测')">${tongjiInfo.dice }</a></td>
													<td><a href="javascript:void(0)"
														onclick="queryNum('${tongjiInfo.checkunit }','','其他')">${tongjiInfo.qita }</a></td>
												</tr>
											</c:forEach>
