										...
										<tbody>
											<c:forEach var="danger"
												...
												<td>${ status.index + (result.pageBean.currentPage-1)*10+1}
													...
													class="dutyPerson_hidden" value="${danger.dutyperson}" />
													<input type="hidden" class="supervisor_hidden"
												...
												<td><c:if test="${'已四定' eq danger.dangerstatus }">
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">
                                            ...
                                            <div class="input-group el_modellist" role="toolbar">
                                                <span class="el_spans">整&nbsp;&nbsp;改&nbsp;&nbsp;时&nbsp;&nbsp;间&nbsp;：</span>
                                                <input type="text" id="recheckTime_update" class="form-control el_modelinput" name="rechecktime"/>
                                                <script type="text/javascript">
