...
<head>
    ...
    <script>
        $().ready(function() {
            $("#traceform").validate({
                rules: {
                    telMethod:"required",//发现日期
                    leader:"required",
                    changetime:"required",
                    safetyperson:"required"
                },
                messages: {
                    telMethod: {required: "不能为空"},
                    leader:{required: "不能为空"},
                    changetime:{required: "不能为空"},
                    safetyperson:{required: "不能为空"}
                }
            });
        });
    </script>
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tr>
                                ...
                                <td>未四定</td>
                                <td>
                                    <a href="javascript:void(0)" data-toggle="modal" data-target="#trace">隐患跟踪</a>
                                    <a href="javascript:void(0)" data-toggle="modal" data-target="#el_FourInfo2">详情</a>
                                    <a href="javascript:void(0)" data-toggle="modal" data-target="#postpone">延期</a>
                                </td>
                            </tr>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <!--标题-->
                                        <h3 class="modal-title">安全隐患问题跟踪记录</h3>
                                    </div>
                                        ...
                                        <form action="" id="traceform">
                                            <div class="input-group el_modellist" role="toolbar">
                                                ...
                                                <label class="el_radioBox el_radioBox2">
                                                    <input type="radio" name="telMethod" checked value="0"> 有
                                                </label>
                                                <label class="el_radioBox el_radioBox2">
                                                    <input type="radio" name="telMethod" value="1"> 无
                                                </label>
                                            </div>

                                            <div class="input-group el_modellist" role="toolbar">
                                                <span class="el_spans">现场领导：</span>
                                                <input type="text" class="form-control el_modelinput" name="leader"/>
                                            </div>

                                            <div class="input-group el_modellist" role="toolbar">
                                                <span class="el_spans">整改时间：</span>
                                                <input type="text" id="datepicker2" class="form-control el_modelinput" name="changetime"/>
                                                <script type="text/javascript">
                                            ...
                                            <div class="input-group el_modellist" role="toolbar">
                                                <span class="el_spans">现场安全员：</span>
                                                <input type="text" class="form-control el_modelinput" name="safetyperson"/>
                                            </div>
                        ...
                        <!-- 模态框 延期-->
                        <div class="modal fade" id="postpone" tabindex="-1" role="dialog"
                             aria-labelledby="myModalLabel"
                             aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
