        ...
        $().ready(function() {
            $("#handleform").validate({
                rules: {
                    ...
                    handlemethod:"required",
                    handletime:"required",
                    handleperson:"required"
                },
                messages: {
                    telmethod: {required: "不能为空"},
                    handlemethod:{required: "不能为空"},
                    handletime:{required: "不能为空"},
                    handleperson:{required: "不能为空"}
                }
            });
        });
    </script>
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tr>
                                ...
                                <td>未四定</td>
                                <td>
                                    <a href="javascript:void(0)" data-toggle="modal" data-target="#el_setFour">现场处理</a>
                                        ...
                                        <form action="" id="handleform">
                                            ...
                                            <div class="input-group el_modellist" role="toolbar">
                                                ...
                                                <label class="el_radioBox el_radioBox2">
                                                    <input type="radio" name="telmethod" checked value="0"> 有安全技术措施
                                                </label>
                                                <label class="el_radioBox el_radioBox2">
                                                    <input type="radio" name="telmethod" value="1"> 没有安全技术措施
                                                </label>
                                            </div>

                                            <div class="input-group el_modellist" role="toolbar">
                                                <span class="el_spans">处理措施：</span>
                                                <textarea class="form-control" rows="4" name="handlemethod"></textarea>
                                            </div>

                                            <div class="input-group el_modellist" role="toolbar">
                                                <span class="el_spans">处理时间：</span>
                                                <input type="text" id="datepicker" class="form-control el_modelinput" name="handletime"/>
                                                <script type="text/javascript">
                                            ...
                                            <div class="input-group el_modellist" role="toolbar">
                                                <span class="el_spans">处&nbsp;&nbsp;理&nbsp;人：</span>
                                                <input type="text" class="form-control el_modelinput" name="handleperson"/>
                                            </div>
