...
<head>
    ...
    <script>
        $().ready(function() {
            $("#hdfourform").validate({
                rules: {
                    changemethod:"required",//发现日期
                    inspectperson:"required",
                    changetime:"required",
                    hdfourtime:"required"
                },
                messages: {
                    changemethod: {required: "不能为空"},
                    inspectperson:{required: "不能为空"},
                    changetime:{required: "不能为空"},
                    hdfourtime:{required: "不能为空"}
                }
            });
        });
    </script>
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tr>
                                ...
                                <td>未四定</td>
                                <td>
                                    <a href="javascript:void(0)" data-toggle="modal" data-target="#el_setFour">四定</a>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="" id="hdfourform">
                                            <div class="input-group el_modellist" role="toolbar">
                                                ...
                                                <textarea class="form-control" rows="2" name="changemethod"></textarea>
                                            </div>
                                            <div class="input-group el_modellist" role="toolbar">
                                                <span class="el_spans">督&nbsp;&nbsp;办&nbsp;人：</span>
                                                <input type="text" class="form-control el_modelinput" name="inspectperson"/>
                                            </div>
                                            ...
                                            <div class="input-group el_modellist" role="toolbar">
                                                ...
                                                <input type="text" id="datepicker" class="form-control el_modelinput" name="hdfourtime"/>
                                                <script type="text/javascript">
                                                    var picker = new Pikaday(
                                                        {
