...
<head>
    ...
    <style>
        ...
        #treeDemo10, #treeDemo13, #treeDemo2 {
            overflow: visible;
            padding: 10px;
            height: auto;
            position: absolute;
        ...
        /*多选*/
        #el_chooseDepart, #el_chooseDepart13 {
            background-color: white;
            min-height: 25px;
            height: auto;
            width: 100%;
        ...
        #el_chooseDepart:active, #el_chooseDepart13:active {
            border-color: #66afe9;
            -webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, .075), 0 0 8px rgba(102, 175, 233, .6);
            box-shadow: inset 0 1px 1px rgba(0, 0, 0, .075), 0 0 8px rgba(102, 175, 233, .6);
        }

        #el_chooseDepart li, #el_chooseDepart13 li {
            list-style: none;
            width: auto;
            margin-right: 10px;
            float: left;
